...
func easyjson7c82d03DecodeGoDemoCh14Easyjson(in *jlexer.Lexer, out *JobInfo) {
...
func easyjson7c82d03EncodeGoDemoCh14Easyjson(out *jwriter.Writer, in JobInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v JobInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeGoDemoCh14Easyjson(&w, v)
...
func (v *JobInfo) UnmarshalJSON(data []byte) error {
	...
	easyjson7c82d03DecodeGoDemoCh14Easyjson(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *JobInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeGoDemoCh14Easyjson(l, v)
}
func easyjson7c82d03DecodeGoDemoCh14Easyjson1(in *jlexer.Lexer, out *Employee) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeGoDemoCh14Easyjson1(out *jwriter.Writer, in Employee) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v Employee) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeGoDemoCh14Easyjson1(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *Employee) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeGoDemoCh14Easyjson1(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *Employee) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeGoDemoCh14Easyjson1(l, v)
}
func easyjson7c82d03DecodeGoDemoCh14Easyjson2(in *jlexer.Lexer, out *BasicInfo) {
	isTopLevel := in.IsStart()
	if in.IsNull() {
		if isTopLevel {
			in.Consumed()
...
func easyjson7c82d03EncodeGoDemoCh14Easyjson2(out *jwriter.Writer, in BasicInfo) {
	out.RawByte('{')
	first := true
	_ = first
	{
...
func (v BasicInfo) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson7c82d03EncodeGoDemoCh14Easyjson2(&w, v)
	return w.Buffer.BuildBytes(), w.Error
}
...
func (v *BasicInfo) UnmarshalJSON(data []byte) error {
	r := jlexer.Lexer{Data: data}
	easyjson7c82d03DecodeGoDemoCh14Easyjson2(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *BasicInfo) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson7c82d03DecodeGoDemoCh14Easyjson2(l, v)
}
